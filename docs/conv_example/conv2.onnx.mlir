module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func @main_graph(%arg0: tensor<?x32x22x22xf32>) -> tensor<?x16x18x18xf32> attributes {input_names = ["X"], output_names = ["Y"]} {
    ...
    %5 = "onnx.Conv4"(%4, %0, %1) {kernel_shape = [5, 5], pads = [0, 0, 0, 0]} : (tensor<?x2x22x22x16xf32>, tensor<1x4x4x2x16x5x5xf32>, tensor<16xf32>) -> tensor<?x1x18x18x16xf32>
    %6 = "onnx.Transpose"(%5) {perm = [0, 1, 4, 2, 3]} : (tensor<?x1x18x18x16xf32>) -> tensor<?x1x16x18x18xf32>
    %7 = "onnx.Constant"() {value = dense<[-1, 16, 18, 18]> : tensor<4xi64>} : () -> tensor<4xi64>
    %8 = "onnx.Reshape"(%6, %7) : (tensor<?x1x16x18x18xf32>, tensor<4xi64>) -> tensor<?x16x18x18xf32>
