module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func @main_graph(%arg0: tensor<?x32x22x22xf32>) -> tensor<?x1x18x18x16xf32> attributes {input_names = ["X"], output_names = ["Z"]} {
    ...
    %5 = "onnx.Conv4"(%4, %0, %1) {kernel_shape = [5, 5], pads = [0, 0, 0, 0]} : (tensor<?x2x22x22x16xf32>, tensor<16x32x5x5xf32>, tensor<16xf32>) -> tensor<?x1x18x18x16xf32>
    %6 = "onnx.Relu"(%5) : (tensor<?x1x18x18x16xf32>) -> tensor<?x1x18x18x16xf32>
    return %6 : tensor<?x1x18x18x16xf32>
  }
